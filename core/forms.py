...
TaskFormSet = inlineformset_factory(Task, TaskStep, form=TaskStepForm, fields=('__all__'), can_delete=False,  extra=4, widgets = {'step': forms.Textarea(attrs={"class": "h-12 min-h-12 max-h-12 block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 "})})